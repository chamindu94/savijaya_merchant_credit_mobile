...
class CheckPrint extends StatefulWidget {
  const CheckPrint({Key? key}) : super(key: key);

  @override
  _CheckPrintState createState() => _CheckPrintState();
}

class _CheckPrintState extends State<CheckPrint> {
