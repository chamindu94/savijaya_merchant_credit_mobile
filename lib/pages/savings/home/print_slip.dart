...
class PrintSlip extends StatefulWidget {
  ...
  final String status, amount, balance;
  final SavingMember member;
  ...
  @override
  _PrintSlipState createState() => _PrintSlipState();
}

class _PrintSlipState extends State<PrintSlip> {
  ...
  Future<void> initPlatformState() async {
    ...
    setState(() {
      ...
      devices.forEach((element) {
        if (element.name!.contains("MTP") || element.name!.contains("PT")) {
              ...
              itemBuilder: (BuildContext context, int index) {
                return InkWell(
                  onTap: () {
                    ...
                    testPrint.savingsSlip(timestamp, widget.member, widget.status, widget.amount, widget.balance);
                  },
                  child: Column(
                    children: [
                      Container(
